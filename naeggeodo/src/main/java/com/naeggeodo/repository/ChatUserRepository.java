...
public interface ChatUserRepository extends JpaRepository<ChatUser, Long>{
	...
	@Query("select new com.naeggeodo.dto.UserNameIdDTO(u.id,u.nickname) from ChatUser cu inner join Users u on u.id = cu.user.id where cu.chatMain.id = :chatMain_id")
